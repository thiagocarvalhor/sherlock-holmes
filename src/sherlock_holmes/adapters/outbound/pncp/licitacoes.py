...
def search_licitacoes_url(
    *,
    ...
    from sherlock_holmes.adapters.outbound.pncp.client import build_url
...
def search_licitacoes(
    *,
    ...
    from sherlock_holmes.adapters.outbound.pncp.client import PncpApiError, request_json
...
def get_licitacao(
    *,
    ...
    from sherlock_holmes.adapters.outbound.pncp.client import request_json
