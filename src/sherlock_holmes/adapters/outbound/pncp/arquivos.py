...
def contract_file_references(
    *,
    ...
    from sherlock_holmes.adapters.outbound.pncp.contratos import list_contrato_arquivos
    from sherlock_holmes.domain.value_objects import resolve_pncp_contract_id
...
def procurement_file_references(
    *,
    ...
    from sherlock_holmes.adapters.outbound.pncp.licitacoes import list_licitacao_arquivos
    from sherlock_holmes.domain.value_objects import resolve_pncp_contract_id
