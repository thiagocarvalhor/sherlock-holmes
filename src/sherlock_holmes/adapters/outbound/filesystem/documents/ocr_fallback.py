...
from sherlock_holmes.adapters.outbound.filesystem.documents.inspection import DirectTextExtraction
from sherlock_holmes.adapters.outbound.filesystem.documents.text_quality import TextQuality, assess_text_quality
