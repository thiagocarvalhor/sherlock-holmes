...
PRESET_ORGAOS: dict[str, dict[str, str]] = {
    ...
    "SMSUB Ṣo Paulo": {"cnpj": "49269236000117", "unidade": "925004"},
...
def record_label(record: dict[str, Any]) -> str:
    ...
    supplier = record.get("nomeRazaoSocialFornecedor") or "fornecedor ṇo informado"
...
def cached_contract_search(
    ...
    result = search_pncp_contracts(
        ...
        gateway=PncpContractSearchGateway(),
