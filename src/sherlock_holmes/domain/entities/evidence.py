...
def evidence_from_document_reference(
    ...
    *,
    ...
    return _record(
        ...
        source_url=getattr(reference, "url", "") or getattr(reference, "uri", ""),
        value=getattr(reference, "title", ""),
        metadata={
            "resource_type": getattr(reference, "resource_type", ""),
            "resource_id": getattr(reference, "resource_id", ""),
            "document_type": getattr(reference, "document_type", ""),
            "sequence": getattr(reference, "sequence", ""),
            "published_at": getattr(reference, "published_at", ""),
        },
        notes=notes,
    )
...
def evidence_from_extracted_text(
    ...
    *,
    ...
    return _record(
        ...
        local_path=getattr(extraction, "path", ""),
        value=getattr(extraction, "text", ""),
        metadata={
            "file_type": getattr(extraction, "file_type", ""),
            "status": getattr(extraction, "status", ""),
            "text_length": getattr(extraction, "text_length", 0),
